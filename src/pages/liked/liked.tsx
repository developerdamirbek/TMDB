...
export const Liked = () => {
  ...
  const likedItems = useLikedItems((state) => state.likedItems);
    ...
    <div style={{ marginTop: 140, paddingBottom: 50 }}>
      <div className="container">

        {
          ...
          ) : <Typography.Title style={{ marginBottom: 40, marginTop: 200, textAlign: 'center', width: '100%' }} level={2}>No Favourite Movies</Typography.Title>
        }
      </div>
    </div>
  )
