...
import { useGetTopRated } from './service/useGetTopRated';
...
export const TopRated = () => {
    ...
    const { data, isLoading } = useGetTopRated(currentPage);
    ...
    return isLoading ? <div style={{ width: "100%", display: "flex", marginTop: 150, justifyContent: "center", alignItems: "center" }}><Spin /></div> : (
        <section style={{ paddingTop: 130, paddingBottom: 30 }}>

            <div className='container'>
                <Typography.Title style={{marginBottom: 40}} level={2}>Top Rated Movies</Typography.Title>
