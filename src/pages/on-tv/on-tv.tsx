...
import { useGetOnTv } from './service/useGetOnTv';
import { Link } from 'react-router-dom';

export const OnTv = () => {

    const [currentPage, setCurrentPage] = useState(1);
    const { data, isLoading } = useGetOnTv(currentPage);
    ...
    return isLoading ? <div style={{ width: "100%", display: "flex", marginTop: 150, justifyContent: "center", alignItems: "center" }}><Spin /></div> : (
        <section style={{ paddingTop: 140, paddingBottom: 30 }}>
            ...
            <Typography.Title style={{marginBottom: 40}} level={2}>On TV</Typography.Title>
