...
import { useGetNowPlaying } from './service/useGetNowPlaying';
...
export const NowPlaying = () => {
    ...
    const { data, isLoading } = useGetNowPlaying(currentPage);
    ...
    return isLoading ? <div style={{ width: "100%", display: "flex", marginTop: 150, justifyContent: "center", alignItems: "center" }}><Spin /></div> : (
        <section style={{ paddingTop: 140, paddingBottom: 30 }}>
            ...
            <Typography.Title style={{marginBottom: 40}} level={2}>Now Playing</Typography.Title>
